...
class AjaxBanco6278
{
	...
	public function ajaxEditarBanco()
	{
		...
		$respuesta = ControladorBanco6278::ctrMostrarBanco($item, $valor);
	...
	public function ajaxVerParciales()
	{
		...
		$respuesta = ControladorBanco6278::ctrMostrarParciales($item, $valor);
	...
	public function ajaxEditarMovimientoBanco6278()
	{
		$tabla = "banco6278";
		...
		$respuesta = ControladorBanco6278::ctrEditarDatos6278($tabla, $datos);
		...
		$respuesta = ModeloBanco6278::mdlRegistroBitacora("bitacora", $datosBitacora);

		$idBanco = $this->idBanco;
		$respuesta = ControladorBanco6278::ctrActualizarValoresMovimiento($idBanco);
...
if (isset($_POST["idPar"])) {
	$verParciales = new AjaxBanco6278();
...
if (isset($_POST["editarIdBanco"])) {
	...
	$editar->ajaxEditarMovimientoBanco6278();
}
