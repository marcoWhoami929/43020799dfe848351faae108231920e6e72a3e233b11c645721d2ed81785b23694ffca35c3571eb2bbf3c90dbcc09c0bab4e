...
class AjaxBanco0198
{
	...
	public function ajaxEditarMovimientoBanco0198()
	{
		$tabla = "banco0198";
		...
		$respuesta = ControladorBanco0198::ctrEditarDatos0198($tabla, $datos);
		...
		$respuesta = ModeloBanco0198::mdlRegistroBitacora("bitacora", $datosBitacora);

		$idBanco = $this->idBanco;
		$respuesta = ControladorBanco0198::ctrActualizarValoresMovimiento($idBanco);
...
if (isset($_POST["editarIdBanco"])) {
	...
	$editar->ajaxEditarMovimientoBanco0198();
}
