		...
		foreach ($idGastos as $key => $value) {
			...
			$diferencia = $saldo- $comprobacion;
				...
				$datos = array("departamento" => $obtenerDatosGasto[0]["departamento"],
					           ...
					           "parciales" => $obtenerDatosGasto[0]["parciales"],
								"parcial1" => $obtenerDatosGasto[0]["par1"],
								"departamentoParcial1" => $obtenerDatosGasto[0]["dpto1"],
								"parcial2" => $obtenerDatosGasto[0]["par2"],
								"departamentoParcial2" => $obtenerDatosGasto[0]["dpto2"],
								"parcial3" => $obtenerDatosGasto[0]["par3"],
								"departamentoParcial3" => $obtenerDatosGasto[0]["dpto3"],
								"parcial4" => $obtenerDatosGasto[0]["par4"],
								"departamentoParcial4" => $obtenerDatosGasto[0]["dpto4"],
								"parcial5" => $obtenerDatosGasto[0]["par5"],
								"departamentoParcial5" => $obtenerDatosGasto[0]["dpto5"],
								"parcial6" => $obtenerDatosGasto[0]["par6"],
								"departamentoParcial6" => $obtenerDatosGasto[0]["dpto6"],
								"parcial7" => $obtenerDatosGasto[0]["par7"],
								"departamentoParcial7" => $obtenerDatosGasto[0]["dpto7"],
								"parcial8" => $obtenerDatosGasto[0]["par8"],
								"departamentoParcial8" => $obtenerDatosGasto[0]["dpto8"],
								"parcial9" => $obtenerDatosGasto[0]["par9"],
								"departamentoParcial9" => $obtenerDatosGasto[0]["dpto9"],
								"parcial10" => $obtenerDatosGasto[0]["par10"],
								"departamentoParcial10" => $obtenerDatosGasto[0]["dpto10"],
								"parcial11" => $obtenerDatosGasto[0]["par11"],
								"departamentoParcial11" => $obtenerDatosGasto[0]["dpto11"],
								"parcial12" => $obtenerDatosGasto[0]["par12"],
								"departamentoParcial12" => $obtenerDatosGasto[0]["dpto12"],
