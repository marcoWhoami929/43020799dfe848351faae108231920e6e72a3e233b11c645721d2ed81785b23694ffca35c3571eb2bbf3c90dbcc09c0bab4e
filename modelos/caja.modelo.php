...
class ModeloCaja{
	...
	/*=============================================
	INGRESOS MAYOREO FEBRERO FEBRERO
	=============================================*/
	...
	static public function mdlOtrosIngresosCaja($tabla, $item, $valor){
	...
	static public function mdlOtrosIngresosCajaF($tabla, $item, $valor){
	...
	static public function mdlMostrarCajaRetenciones($tabla, $item, $valor){
	...
	static public function mdlAgregarDatos($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(departamento, grupo, subgrupo, mes, fecha, descripcion, cargo, abono, saldo, parciales, parcial, departamentoParcial1, parcial2, departamentoParcial2, parcial3, departamentoParcial3, parcial4, departamentoParcial4, parcial5, departamentoParcial5, parcial6, departamentoParcial6, parcial7, departamentoParcial7, parcial8, departamentoParcial8, parcial9, departamentoParcial9, parcial10, departamentoParcial10, parcial11, departamentoParcial11, parcial12, departamentoParcial12, serie, folio, acreedor, concepto, numeroDocumento, tieneIva, tieneRetenciones, tipoRetencion, importeRetenciones, ultimoSaldo) VALUES(:departamento, :grupo, :subgrupo, :mes, :fecha, :descripcion, :cargo, :abono, :saldo, :parciales, :parcial, :departamentoParcial1, :parcial2, :departamentoParcial2, :parcial3, :departamentoParcial3, :parcial4, :departamentoParcial4, :parcial5, :departamentoParcial5, :parcial6, :departamentoParcial6, :parcial7, :departamentoParcial7, :parcial8, :departamentoParcial8, :parcial9, :departamentoParcial9, :parcial10, :departamentoParcial10, :parcial11, :departamentoParcial11, :parcial12, :departamentoParcial12, :serie, :folio, :acreedor, :concepto, :numeroDocumento, :tieneIva, :tieneRetenciones, :tipoRetencion, :importeRetenciones, :ultimoSaldo)");
	...
	static public function mdlCalcularFolio($tabla){
			...
			$stmt = Conexion::conectar()->prepare("UPDATE $tabla set numeroMovimiento = id");
	...
	CALCULAR  SALDO
	=============================================*/
	static public function mdlCalcularSaldo($tabla){

			$stmt = Conexion::conectar()->prepare("UPDATE $tabla set saldo = ultimoSaldo+abono-cargo where id != 1");
	...
	static public function mdlEditarDatos($tabla, $datos){
	...
	=============================================*/
	static public function mdlRecalcularUltimoSaldo($tabla){

			$stmt = Conexion::conectar()->prepare("UPDATE $tabla set ultimoSaldo = saldo+cargo-abono where id != 1 ");
	...
	RECALCULAR SALDO
	=============================================*/
	static public function mdlRecalcularSaldo($tabla){
	...
	/*=============================================
	ELIMINAR REGISTRO CAJA
	=============================================*/

	static public function mdlEliminarRegistroCaja($tabla, $datos){
