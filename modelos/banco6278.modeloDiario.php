...
class ModeloBanco6278Diario{
	...
	static public function mdlMostrarSaldo($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT cargo,abono,saldo FROM $tabla ORDER BY id ASC LIMIT 1");
	...
	static public function mdlOtrosIngresos6278($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(abono) as otrosIngresos FROM $tabla WHERE grupo = 'INGRESOS' and subgrupo = 'Otros Ingresos' and mes = 'ENERO'");
	...
	static public function mdlOtrosIngresos6278F($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(abono) as otrosIngresos FROM $tabla WHERE grupo = 'INGRESOS' and subgrupo = 'Otros Ingresos' and mes = 'FEBRERO'");
	...
	static public function mdlIngresosIndustrial($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(importe) as ingresos FROM $tabla WHERE departamento = 'INDUSTRIAL' and grupo = 'INGRESOS' and subgrupo = 'Clientes' and mes = 'ENERO'");
	...
	static public function mdlIngresosIndustrialF($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(importe) as ingresos FROM $tabla WHERE departamento = 'INDUSTRIAL' and grupo = 'INGRESOS' and subgrupo = 'Clientes' and mes = 'FEBRERO'");
	...
	static public function mdlIngresosMayoreo($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(importe) as ingresos FROM $tabla WHERE departamento = 'CEDIS' and grupo = 'INGRESOS' and mes = 'ENERO'");
	...
	/*=============================================
	INGRESOS MAYOREO  FEBRERO
	=============================================*/

	static public function mdlIngresosMayoreoF($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(importe) as ingresos FROM $tabla WHERE departamento = 'CEDIS' and grupo = 'INGRESOS' and mes = 'FEBRERO'");
	...
	/*=============================================
	INGRESOS PARCIALES MAYOREO  FEBRERO
	=============================================*/

	static public function mdlIngresosMayoreoParcialesF($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(parcial)-7462 as ingresos FROM banco6278 WHERE departamentoParcial1 = 'CEDIS' and grupo = 'INGRESOS' and mes = 'FEBRERO'");
	...
	REEMBOLSOS CLIENTES
	=============================================*/
	static public function mdlReembolsosClientes($tabla, $item, $valor){
		...
		if ($item != null) {
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(importe) as reembolsos FROM $tabla where subgrupo = 'Reembolsos a Clientes' AND mes = 'ENERO' and departamento = 'CEDIS'");
	...
	/*=============================================
	REEMBOLSOS CLIENTES FEBRERO
	=============================================*/
	static public function mdlReembolsosClientesF($tabla, $item, $valor){
		...
		if ($item != null) {
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(importe) as reembolsos FROM $tabla where subgrupo = 'Reembolsos a Clientes' and mes = 'FEBRERO' and departamento = 'CEDIS'");
	...
	/*=============================================
	REEMBOLSOS CLIENTES TIENDAS
	=============================================*/
	static public function mdlReembolsosClientesTiendas($tabla, $item, $valor){
		...
		if ($item != null) {
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(importe) as reembolsos FROM $tabla where grupo = 'INGRESOS' and subgrupo = 'Reembolsos a Clientes' and mes = 'ENERO' and departamento != 'CEDIS'");
	...
	/*=============================================
	REEMBOLSOS CLIENTES TIENDAS FEBRERO
	=============================================*/
	static public function mdlReembolsosClientesTiendasF($tabla, $item, $valor){
		...
		if ($item != null) {
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(importe) as reembolsos FROM $tabla where grupo = 'INGRESOS' and subgrupo = 'Reembolsos a Clientes' and mes = 'FEBRERO' and departamento != 'CEDIS'");
	...
	INGRESOS SANTIAGO
	=============================================*/
	static public function mdlIngresosSantiago($tabla, $item, $valor){
		...
		if ($item != null) {
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(importe) as ingresos FROM $tabla WHERE departamento = 'SANTIAGO' and grupo = 'INGRESOS' and subgrupo = 'Clientes' and mes = 'ENERO'");
	...
	=============================================*/
	static public function mdlIngresosSantiagoF($tabla, $item, $valor){
		...
		if ($item != null) {
			...
			$stmt = Conexion::conectar()->prepare("SELECT SUM(importe) as ingresos FROM $tabla WHERE departamento = 'SANTIAGO' and grupo = 'INGRESOS' and subgrupo = 'Clientes' and mes = 'FEBRERO'");
	...
	static public function mdlAgregarDatos6278($tabla, $datos){
