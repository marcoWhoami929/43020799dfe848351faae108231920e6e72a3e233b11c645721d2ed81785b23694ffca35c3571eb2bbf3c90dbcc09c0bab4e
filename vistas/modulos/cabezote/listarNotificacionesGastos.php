...
if (isset($_POST['view'])) {
    ...
    if ($_POST["view"] != '') {
        $update_query = "UPDATE notificacionesgastos SET estatus = 1 WHERE id = '".$_POST["view"]."' and  estatus=0";
        mysqli_query($conn, $update_query);
    }
    $usuario = $_SESSION["id"];
    $query  = "SELECT * FROM notificacionesgastos where autorGasto = '".$usuario."' ORDER BY id DESC";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            if ($row["estatus"] == 1) {
              ...
              $output .= '
            <li class="notifyIdGasto" id="'.$row["id"].'" style="background:#efe6dd;color:white;">
            <a href="#">
    ...
    $status_query = "SELECT * FROM notificacionesgastos WHERE estatus=0 and autorGasto = '".$usuario."'";
