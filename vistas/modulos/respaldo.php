  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Gestor respaldo</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
                ...
                <?php 
                      ...
                      class Backup_Database {
                          ...
                          public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
                              ...
                              $this->backupFile      = 'respaldo-'.$this->dbName.'-'.date("Ymd_His", time()).'.sql';
        ...
        <div class="box-footer">
          <strong>Nota importante:</strong><p>Se recomienda realizar el respaldo para evitar pérdida de datos, si se realiza algún dato importante generar respaldo.</p>
