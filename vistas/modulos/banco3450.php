...
if($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos" || $_SESSION["perfil"] == "Credito y Cobranza" || $_SESSION["perfil"] == "Contabilidad" || $_SESSION["perfil"] == "Compras"){
    ...
    if (isset($_SESSION["user_id"]) == true && $_SESSION['googleVerifyCode'] == true) {
      ...
      echo "<script> window.location = 'acceso3450'; </script>";
      ...
      <div class="box-body">
        <div class="box-tools">
          ...
          if ($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos") {
            echo '<a href="vistas/modulos/reportes.php?reporteBancos=banco3450">
           ...
           <button class="report btn btn-info" id="report" name="report" onclick="myFunction()"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Reporte</button>
              ...
              echo '<a href="vistas/modulos/reportes.php?reporteBancosCredito=banco3450">
            ...
            <button class="report btn btn-info" id="report" name="report" onclick="myFunction()"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Reporte</button>
              ...
              echo '
            <a href="vistas/modulos/reportes.php?reporteBancos=banco3450">

            <button class="report btn btn-info" id="report" name="report" onclick="myFunction()"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Reporte</button>

          </a>
          <a href="vistas/modulos/reportes.php?reporteBancosEdicion=banco3450">
        ...
        if ($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos") {
          ...
          echo '<div class="">
          <div class="row">
            <form action="import3450.php" method="post" enctype="multipart/form-data" id="import_form">
              <div class="col-md-4">
             ...
             <?php 
                ...
                //$calcularFolioImportacion =  new ControladorBanco3450();
                //$calcularFolioImportacion -> ctrCalcularFolioImportacion();

                $comprobacionImportacion =  new ControladorBanco3450();
                $comprobacionImportacion -> ctrCalcularComprobacionImportacion();

                $calcularDiferenciaImportacion = new ControladorBanco3450();
        ...
        if ($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos" || $_SESSION["perfil"] == "Contabilidad") {
            ...
            echo '<table class="table-bordered table-striped dt-responsive tablaBanco3450" width="100%" id="banco3450" style="border: 2px solid #187092">
          ...
          <thead style="background:#187092;color: white">
           ...
           <tr style="">
            ...
            echo '<table class="table-bordered table-striped dt-responsive tablaBanco3450Credito" width="100%" id="banco3450credito" style="border: 2px solid #187092">
...
$item = null;
$valor = null;
$banco3450Valores = ControladorBanco3450::ctrMostrarBanco($item, $valor);

foreach ($banco3450Valores as $key => $value4) {
  ...
  <div class="modal-dialog" style="width: 80%;">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        $editarDatos = new ControladorBanco3450();
        $editarDatos -> ctrEditarDatos3450();

        $registroBitacora =  new ControladorBanco3450();
        $registroBitacora -> ctrRegistroBitacora(); 

                $calcularImporteImportacion =  new ControladorBanco3450();
                $calcularImporteImportacion -> ctrCalcularImporteImportacion();

                $calcularImporteParciales = new ControladorBanco3450();
                $calcularImporteParciales -> ctrCalcularImporteParciales();

                $calcularIvaImportacion = new ControladorBanco3450();
                $calcularIvaImportacion -> ctrCalcularIvaImportacion();

                $calcularIvaArrendamientoImportacion = new ControladorBanco3450();
                $calcularIvaArrendamientoImportacion -> ctrCalcularIva1Importacion();

                $calcularIsrArrendamientoImportacion = new ControladorBanco3450();
                $calcularIsrArrendamientoImportacion -> ctrCalcularIsr1Importacion();

                $calcularIvaFleteImportacion = new ControladorBanco3450();
                $calcularIvaFleteImportacion -> ctrCalcularIva2Importacion();

                $calcularIsrFleteImportacion = new ControladorBanco3450();
                $calcularIsrFleteImportacion -> ctrCalcularIsr2Importacion();

                $calcularIvaHonorariosImportacion = new ControladorBanco3450();
                $calcularIvaHonorariosImportacion -> ctrCalcularIva3Importacion();

                $calcularIsrHonorariosImportacion = new ControladorBanco3450();
...
<div class="modal fade" id="list-archive" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#187092;color: white;">
        <h5 class="modal-title" id="exampleModalLabel" style="font-size: 15px;font-weight: bold">LISTA DE RESPALDOS BANCO3450</h5>
      ...
      <div class="modal-body" id="list-archives" style="overflow: scroll;height: 300px">
            <?php
                function listar_archivos($carpeta){
                    ...
                    if(is_dir($carpeta)){
                        if($dir = opendir($carpeta)){
                           $total_respaldos = count(glob('Respaldo-Banco3450/{*.gz}',GLOB_BRACE));
                           
                            while(($archivo = readdir($dir)) !== false && $total_respaldos > 0){
                                
                                if($archivo != '.' && $archivo != '..' && $archivo != '.htaccess'){
                                    //echo '<li><a target="_blank" href="'.$carpeta.'/'.$archivo.'"></a></li>';
                                    echo '<input type="text" value="'.$archivo.'" id="'.$archivo.'" style="width:70%; border:none;" onfocus="clickInput()">';
                ...
                echo listar_archivos('Respaldo-Banco3450');
    ...
    <script type="text/javascript">
      ...
      function agregar(){
       ...
       function respaldo(){
        ...
        var request = new XMLHttpRequest();
          ...
          request.open('GET', 'http://dkmatrizz.ddns.net/respaldosBancos.php?funcion=respaldo3450');
          request.send();
      ...
      function restaurar(){
        $.ajax({
          ...
          method: "GET",
          async: false,
          data: {funcion: "restauracionBanco3450", direccion: $('input[name="direccion"]').val()},
          dataType: "json",
          success: function(response){
        ...
        var Url = "http://dkmatrizz.ddns.net/restauracionBancos.php?funcion=restauracionBanco3450&direccion="+CustomerNumber;
