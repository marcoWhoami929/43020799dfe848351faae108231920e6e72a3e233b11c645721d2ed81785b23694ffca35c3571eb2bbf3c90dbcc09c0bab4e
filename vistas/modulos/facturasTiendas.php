        ...
        <?php 
          ...
          ?>
             ...
             <?php
              ...
              if ($_SESSION["perfil"] == "Administrador General" || $_SESSION["nombre"] == "José Martinez"  || $_SESSION["perfil"] == "Credito y Cobranza" || $_SESSION["nombre"] == "Ivan Herrera Perez") {?>
                  <?php
