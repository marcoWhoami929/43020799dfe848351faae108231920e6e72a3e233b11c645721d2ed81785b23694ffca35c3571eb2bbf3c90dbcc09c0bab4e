<script type="text/javascript">
  ...
  title: {
    text: 'Unidades surtidas por agente'
  },
  tooltip: {
...

      {
        name: 'GOMEZ RODRIGUEZ ERICK',
         ...
         <?php
          ...
          $agente3 = (($valorErick[2][3])+($valorErick[3][3]));
