        ...
        <div class="box-tools">
          <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="col-md-3">
              ...
              <a onclick="reporteRangoFechasCredito6278()">
...
<div id="modalEditarDatos" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog" style="width: 80%;">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data" id="editarMovimientoBanco6278Credito">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="minimizar6278Credito">Salir</button>
       ...
       <script type="text/javascript">
           shortcut.add("Ctrl+X",function() {
            ...
            shortcut.add("Esc",function() {
                 document.getElementById("minimizar6278Credito").click();
            });
