 ...
 <div class="content-wrapper" style="margin-bottom: 150px;">
    ...
    <section class="content" >
      ...
      <div class="row">
        ...
        <?php
          if ($_SESSION["nombre"] == "Sucursal San Manuel" || $_SESSION["nombre"] == "Sucursal Santiago" || $_SESSION["nombre"] == "Sucursal Capu" || $_SESSION["nombre"] == "Sucursal Las Torres" || $_SESSION["nombre"] == "Sucursal Reforma" || $_SESSION["nombre"] == "Sucursal Acatepec") {
        ...
        <?php
          if ($_SESSION["nombre"] == "Roberto Gutierrez" || $_SESSION["perfil"] == "Administrador General" || $_SESSION["nombre"] == "Annet Landa Alvarado" || $_SESSION["nombre"] == "Sebastián Rodríguez" || $_SESSION["perfil"] == "Credito y Cobranza") {
