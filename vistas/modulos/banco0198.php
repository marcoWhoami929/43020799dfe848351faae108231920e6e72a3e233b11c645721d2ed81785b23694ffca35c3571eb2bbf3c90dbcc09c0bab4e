      ...
      <div class="box-body">
        ...
        <?php
          if ($_SESSION["perfil"] == "Bancos" || $_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Contabilidad") {
            ...
            echo '<table class="table-bordered table-striped dt-responsive tablaBanco0198" width="100%" id="banco0198"  style="border: 2px solid #187092">
          ...
          <thead style="background:#187092;color: white">
           ...
           <tr style="">
            ...
            echo '<table class="table-bordered table-striped dt-responsive tablaBanco0198Credito" width="100%" id="banco0198credito" style="border: 2px solid #187092">
...
<div class="modal fade" id="list-archive" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#187092;color: white;">
        <h5 class="modal-title" id="exampleModalLabel" style="font-size: 15px;font-weight: bold">LISTA DE RESPALDOS BANCO0198</h5>
      ...
      <div class="modal-body" id="list-archives" style="overflow: scroll;height: 300px">
            <?php
                function listar_archivos($carpeta){
                    ...
                    if(is_dir($carpeta)){
                        if($dir = opendir($carpeta)){
                           $total_respaldos = count(glob('Respaldo-Banco0198/{*.gz}',GLOB_BRACE));
                ...
                echo listar_archivos('Respaldo-Banco0198');
  ...
  <div class="modal-dialog" role="document" style="width: 50%">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <form action="vistas/modulos/reportes/reporte0198.php" method="POST">
                  <div class="container col-lg-12">
                    <div class="row">
                      <div class="col-lg-6">
    ...
    <script type="text/javascript">
      ...
      function respaldo(){
        ...
        var request = new XMLHttpRequest();
          ...
          request.open('GET', 'http://dkmatrizz.ddns.net/respaldosBancos.php?funcion=respaldo0198');
          request.send();
      ...
      function restaurar(){
        $.ajax({
          ...
          method: "GET",
          async: false,
          data: {funcion: "restauracionBanco0198", direccion: $('input[name="direccion"]').val()},
          dataType: "json",
          success: function(response){
        ...
        var Url = "http://dkmatrizz.ddns.net/restauracionBancos.php?funcion=restauracionBanco0198&direccion="+CustomerNumber;
