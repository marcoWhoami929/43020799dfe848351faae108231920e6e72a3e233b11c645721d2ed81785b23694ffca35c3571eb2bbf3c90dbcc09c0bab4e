...
if($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos" || $_SESSION["perfil"] == "Credito y Cobranza" || $_SESSION["perfil"] == "Contabilidad" || $_SESSION["perfil"] == "Compras"){
    ...
    if (isset($_SESSION["user_id"]) == true && $_SESSION['googleVerifyCode'] == true) {
      ...
      echo "<script> window.location = 'acceso1286'; </script>";
      ...
      <div class="box-body">
        <div class="box-tools">
          ...
          if ($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos") {
            echo '<a href="vistas/modulos/reportes.php?reporteBancos=banco1286">
          ...
          <button class="respaldo btn btn-warning" id="respaldo" name="respaldo" onclick="respaldo()"><i class="fa fa-database" aria-hidden="true"></i>Reporte</button>';
              ...
              echo '<a href="vistas/modulos/reportes.php?reporteBancosCredito=banco1286">
            ...
            <button class="report btn btn-info" id="report" name="report" onclick="myFunction()"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Reporte</button>
              ...
              echo '
            <a href="vistas/modulos/reportes.php?reporteBancos=banco1286">

            <button class="report btn btn-info" id="report" name="report" onclick="myFunction()"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Reporte</button>

          </a>
          <a href="vistas/modulos/reportes.php?reporteBancosEdicion=banco1286">
        ...
        if ($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos") {
            ...
            echo '<div class="">
          <div class="row">
            <form action="import1286.php" method="post" enctype="multipart/form-data" id="import_form">
              <div class="col-md-4">
              ...
              ?>
             <?php 
                //$calcularFolioImportacion =  new ControladorBanco1286();
                //$calcularFolioImportacion -> ctrCalcularFolioImportacion();

                $comprobacionImportacion =  new ControladorBanco1286();
                $comprobacionImportacion -> ctrCalcularComprobacionImportacion();

                $calcularDiferenciaImportacion = new ControladorBanco1286();
        ...
        <?php
          if ($_SESSION["perfil"] == "Bancos" || $_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Contabilidad") {
            ...
            echo '<table class="table-bordered table-striped dt-responsive tablaBanco1286" width="100%" id="banco1286"  style="border: 2px solid #187092">
          ...
          <thead style="background:#187092;color: white">
           ...
           <tr style="">
            ...
            echo '<table class="table-bordered table-striped dt-responsive tablaBanco1286Credito" width="100%" id="banco1286credito" style="border: 2px solid #187092">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
                       ...
                       <span style="font-weight: bold">Tipo de Retención</span>
                        <div class="input-group">
                          ...
                          <select class="form-control" name="editarTipoRetencion" id="editarTipoRetencion">
                            ...
                            <option value="Arrendamiento(simplificado)">Arrendamiento(simplificado)</option>
        ...
        <?php
                ...
                $editarDatos = new ControladorBanco1286();
                $editarDatos -> ctrEditarDatos1286();

                $registroBitacora =  new ControladorBanco1286();
                $registroBitacora -> ctrRegistroBitacora(); 

                $calcularImporteParciales = new ControladorBanco1286();
                $calcularImporteParciales -> ctrCalcularImporteParciales();

                

                $calcularImporteImportacion =  new ControladorBanco1286();
                $calcularImporteImportacion -> ctrCalcularImporteImportacion();

                

                $calcularIvaImportacion = new ControladorBanco1286();
                $calcularIvaImportacion -> ctrCalcularIvaImportacion();

                $calcularIvaArrendamientoImportacion = new ControladorBanco1286();
                $calcularIvaArrendamientoImportacion -> ctrCalcularIva1Importacion();

                $calcularIsrArrendamientoImportacion = new ControladorBanco1286();
                $calcularIsrArrendamientoImportacion -> ctrCalcularIsr1Importacion();

                $calcularIvaFleteImportacion = new ControladorBanco1286();
                $calcularIvaFleteImportacion -> ctrCalcularIva2Importacion();

                $calcularIsrFleteImportacion = new ControladorBanco1286();
                $calcularIsrFleteImportacion -> ctrCalcularIsr2Importacion();

                $calcularIvaHonorariosImportacion = new ControladorBanco1286();
                $calcularIvaHonorariosImportacion -> ctrCalcularIva3Importacion();

                $calcularIsrHonorariosImportacion = new ControladorBanco1286();
...
<div class="modal fade" id="list-archive" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#187092;color: white;">
        <h5 class="modal-title" id="exampleModalLabel" style="font-size: 15px;font-weight: bold">LISTA DE RESPALDOS BANCO1286</h5>
      ...
      <div class="modal-body" id="list-archives" style="overflow: scroll;height: 300px">
            <?php
                function listar_archivos($carpeta){
                    ...
                    if(is_dir($carpeta)){
                        if($dir = opendir($carpeta)){
                           $total_respaldos = count(glob('Respaldo-Banco1286/{*.gz}',GLOB_BRACE));
                ...
                echo listar_archivos('Respaldo-Banco1286');
  ...
  <div class="modal-dialog" role="document" style="width: 50%">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <form action="vistas/modulos/reportes/reporte1286.php" method="POST">
                  <div class="container col-lg-12">
                    <div class="row">
                      <div class="col-lg-6">
    ...
    <script type="text/javascript">
      ...
      function respaldo(){
        ...
        var request = new XMLHttpRequest();
          ...
          request.open('GET', 'http://dkmatrizz.ddns.net/respaldosBancos.php?funcion=respaldo1286');
          request.send();
      ...
      function restaurar(){
        $.ajax({
          ...
          method: "GET",
          async: false,
          data: {funcion: "restauracionBanco1286", direccion: $('input[name="direccion"]').val()},
          dataType: "json",
          success: function(response){
        ...
        var Url = "http://dkmatrizz.ddns.net/restauracionBancos.php?funcion=restauracionBanco1286&direccion="+CustomerNumber;
