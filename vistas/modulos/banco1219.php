...
if($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos" || $_SESSION["perfil"] == "Credito y Cobranza" || $_SESSION["perfil"] == "Contabilidad" || $_SESSION["perfil"] == "Compras"){
    ...
    if (isset($_SESSION["user_id"]) == true && $_SESSION['googleVerifyCode'] == true) {
      ...
      echo "<script> window.location = 'acceso1219'; </script>";
      ...
      <div class="box-body">
        <div class="box-tools">
          ...
          if ($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos") {
            echo '<a href="vistas/modulos/reportes.php?reporteBancos=banco1219">
          ...
          <button class="respaldo btn btn-warning" id="respaldo" name="respaldo" onclick="respaldo()"><i class="fa fa-database" aria-hidden="true"></i>Reporte</button>';
              ...
              echo '<a href="vistas/modulos/reportes.php?reporteBancosCredito=banco1219">
            ...
            <button class="report btn btn-info" id="report" name="report" onclick="myFunction()"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Reporte</button>
              ...
              echo '
            <a href="vistas/modulos/reportes.php?reporteBancos=banco1219">

            <button class="report btn btn-info" id="report" name="report" onclick="myFunction()"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Reporte</button>

          </a>
          <a href="vistas/modulos/reportes.php?reporteBancosEdicion=banco1219">
        ...
        if ($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos") {
            ...
            echo '<div class="">
          <div class="row">
            <form action="import1219.php" method="post" enctype="multipart/form-data" id="import_form">
              <div class="col-md-4">
              ...
              ?>
             <?php 
                //$calcularFolioImportacion =  new ControladorBanco1219();
                //$calcularFolioImportacion -> ctrCalcularFolioImportacion();

                $comprobacionImportacion =  new ControladorBanco1219();
                $comprobacionImportacion -> ctrCalcularComprobacionImportacion();

                $calcularDiferenciaImportacion = new ControladorBanco1219();
        ...
        <?php
          if ($_SESSION["perfil"] == "Bancos" || $_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Contabilidad") {
            ...
            echo '<table class="table-bordered table-striped dt-responsive tablaBanco1219" width="100%" id="banco1219"  style="border: 2px solid #187092">
          ...
          <thead style="background:#187092;color: white">
           ...
           <tr style="">
            ...
            echo '<table class="table-bordered table-striped dt-responsive tablaBanco1219Credito" width="100%" id="banco1219credito" style="border: 2px solid #187092">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <?php
                ...
                $editarDatos = new ControladorBanco1219();
                $editarDatos -> ctrEditarDatos1219();

                $registroBitacora =  new ControladorBanco1219();
                $registroBitacora -> ctrRegistroBitacora(); 

                $calcularImporteImportacion =  new ControladorBanco1219();
                $calcularImporteImportacion -> ctrCalcularImporteImportacion();

                $calcularImporteParciales = new ControladorBanco1219();
                $calcularImporteParciales -> ctrCalcularImporteParciales();

                $calcularIvaImportacion = new ControladorBanco1219();
                $calcularIvaImportacion -> ctrCalcularIvaImportacion();

                $calcularIvaArrendamientoImportacion = new ControladorBanco1219();
                $calcularIvaArrendamientoImportacion -> ctrCalcularIva1Importacion();

                $calcularIsrArrendamientoImportacion = new ControladorBanco1219();
                $calcularIsrArrendamientoImportacion -> ctrCalcularIsr1Importacion();

                $calcularIvaFleteImportacion = new ControladorBanco1219();
                $calcularIvaFleteImportacion -> ctrCalcularIva2Importacion();

                $calcularIsrFleteImportacion = new ControladorBanco1219();
                $calcularIsrFleteImportacion -> ctrCalcularIsr2Importacion();

                $calcularIvaHonorariosImportacion = new ControladorBanco1219();
                $calcularIvaHonorariosImportacion -> ctrCalcularIva3Importacion();

                $calcularIsrHonorariosImportacion = new ControladorBanco1219();
...
<div class="modal fade" id="list-archive" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#187092;color: white;">
        <h5 class="modal-title" id="exampleModalLabel" style="font-size: 15px;font-weight: bold">LISTA DE RESPALDOS BANCO1219</h5>
      ...
      <div class="modal-body" id="list-archives" style="overflow: scroll;height: 300px">
            <?php
                function listar_archivos($carpeta){
                    ...
                    if(is_dir($carpeta)){
                        if($dir = opendir($carpeta)){
                           $total_respaldos = count(glob('Respaldo-Banco1219/{*.gz}',GLOB_BRACE));
                ...
                echo listar_archivos('Respaldo-Banco1219');
  ...
  <div class="modal-dialog" role="document" style="width: 50%">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <form action="vistas/modulos/reportes/reporte1219.php" method="POST">
                  <div class="container col-lg-12">
                    <div class="row">
                      <div class="col-lg-6">
    ...
    <script type="text/javascript">
      ...
      function respaldo(){
        ...
        var request = new XMLHttpRequest();
          ...
          request.open('GET', 'http://dkmatrizz.ddns.net/respaldosBancos.php?funcion=respaldo1219');
          request.send();
      ...
      function restaurar(){
        $.ajax({
          ...
          method: "GET",
          async: false,
          data: {funcion: "restauracionBanco1219", direccion: $('input[name="direccion"]').val()},
          dataType: "json",
          success: function(response){
        ...
        var Url = "http://dkmatrizz.ddns.net/restauracionBancos.php?funcion=restauracionBanco1219&direccion="+CustomerNumber;
