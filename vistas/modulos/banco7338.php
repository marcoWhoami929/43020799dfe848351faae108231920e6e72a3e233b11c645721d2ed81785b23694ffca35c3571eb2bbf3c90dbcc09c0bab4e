...
if ($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos" || $_SESSION["perfil"] == "Credito y Cobranza" || $_SESSION["perfil"] == "Contabilidad" || $_SESSION["perfil"] == "Compras") {
    ...
    if (isset($_SESSION["user_id"]) == true && $_SESSION['googleVerifyCode'] == true) {
        ...
        echo "<script> window.location = 'acceso7338'; </script>";
    }
} else {
    echo '<script>
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <button class="respaldo btn btn-warning" id="respaldo" name="respaldo" onclick="respaldo()"><i class="fa fa-database" aria-hidden="true"></i>Reporte</button>';
                            ...
                            echo '<a href="vistas/modulos/reportes.php?reporteBancosGeneral=banco7338">
                  ...
                  <div class="col-md-1">
                    ...
                    <a href="vistas/modulos/reportes.php?reporteBancosCredito=banco7338">
                  ...
                  <div class="col-md-3">';
                            ...
                            echo '<a onclick="reporteRangoFechasCredito7338()">
                  ...
                  <div class="col-md-3">';
                            ...
                            echo '<a onclick="reporteRangoFechas7338()">
                  ...
                  <button class="report btn btn-info" id="reportRangoF"  name="report"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Reporte Rango de Fechas</button>
                        ...
                        echo '
              <a href="vistas/modulos/reportes.php?reporteBancosEdicion=banco7338">
              ...
              <button class="report btn btn-info" id="reportRangoF"  ><i class="fa fa-file-excel-o" aria-hidden="true"></i> Reporte Rango de Fechas</button>
                ...
                if ($_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Bancos") {
                    ...
                    echo '<div class="col-lg-12 col-md-12 col-sm-12">
              <form action="import7338.php" method="post" enctype="multipart/form-data" id="import_form">
                <div class="col-md-3">
                ...
                <?php
                    //$calcularFolioImportacion =  new ControladorBanco7338();
                    //$calcularFolioImportacion -> ctrCalcularFolioImportacion();

                    $comprobacionImportacion =  new ControladorBanco7338();
                    $comprobacionImportacion->ctrCalcularComprobacionImportacion();

                    $calcularDiferenciaImportacion = new ControladorBanco7338();
                ...
                if ($_SESSION["perfil"] == "Credito y Cobranza" || $_SESSION["perfil"] == "Compras") {
                    ...
                    $accion = "cargarBanco7338Credito();";
                } else {
                    $accion = "cargarBanco7338();";
                }
                ...
                if ($_SESSION["perfil"] == "Bancos" || $_SESSION["perfil"] == "Administrador General" || $_SESSION["perfil"] == "Contabilidad") {
                    ...
                    echo '<table class="table-bordered table-striped dt-responsive tablaBanco7338" width="100%" id="banco7338"  style="border: 2px solid #187092">
          ...
          <thead style="background:#187092;color: white">
           ...
           <tr style="">
             ...
             <th style="border:none">Error Diferencia</th>
                    ...
                    echo '<table class="table-bordered table-striped dt-responsive tablaBanco7338Credito" width="100%" id="banco7338credito" style="border: 2px solid #187092">
...
<div class="modal fade" id="list-archive" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background:#187092;color: white;">
                <h5 class="modal-title" id="exampleModalLabel" style="font-size: 15px;font-weight: bold">LISTA DE RESPALDOS BANCO7338</h5>
            ...
            <div class="modal-body" id="list-archives" style="overflow: scroll;height: 300px">
                ...
                function listar_archivos($carpeta)
                {
                    ...
                    if (is_dir($carpeta)) {
                        if ($dir = opendir($carpeta)) {
                            $total_respaldos = count(glob('Respaldo-Banco7338/{*.gz}', GLOB_BRACE));
                ...
                echo listar_archivos('Respaldo-Banco7338');
    ...
    <div class="modal-dialog" role="document" style="width: 50%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="vistas/modulos/reportes/reporte7338.php" method="POST">
                    <div class="container col-lg-12">
                        <div class="row">
                            <div class="col-lg-6">
...
<script type="text/javascript">
    ...
    function respaldo() {
        ...
        request.open('GET', 'http://dkmatrizz.ddns.net/respaldosBancos.php?funcion=respaldo7338');
        request.send();
    ...
    function restaurar() {
        ...
        var Url = "http://dkmatrizz.ddns.net/restauracionBancos.php?funcion=restauracionBanco7338&direccion=" + CustomerNumber;
