  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="container">
              ...
              <div class="row">
               <form action="indicadores" method="POST">
                <div class="container">
                  <div class="col-lg-3">
                    <?php
      ...
      <?php
        include("inicio/graficoNivelPartidas.php");
        include("inicio/graficoNivelSurtimiento.php");
        include("inicio/graficoNivelSurtimientoCosto.php");
