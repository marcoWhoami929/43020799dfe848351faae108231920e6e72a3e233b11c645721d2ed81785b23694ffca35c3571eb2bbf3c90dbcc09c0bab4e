...
function cargarBanco7338() {
  ...
  $(".tablaBanco7338").DataTable({
    ...
    serverSide: true,
    sAjaxSource:
      "ajax/processDataBancos.php?action=banco&banco=banco7338&filtro1=" +
      filtro1 +
      "&fechaInicio=" +
      fechaInicio +
      "&fechaFinal=" +
...
function reporteRangoFechas7338() {
  var filtro1 = $("#departamentoSelect").val();
  var fechaInicio = $("#fechaIni").val();
  var fechaFinal = $("#fechaFin").val();
  var filtro2 = $("#movimientoSelect").val();
  ...
  location.href =
    "vistas/modulos/reportes.php?bancoRangoFechas=banco7338&filtro1=" +
    filtro1 +
    "&fechaInicio=" +
    fechaInicio +
    "&fechaFinal=" +
...
function reporteRangoFechasCredito7338() {
  var filtro1 = $("#departamentoSelect").val();
  var fechaInicio = $("#fechaIni").val();
  var fechaFinal = $("#fechaFin").val();
  var filtro2 = $("#movimientoSelect").val();
  ...
  location.href =
    "vistas/modulos/reportes.php?bancoRangoFechasCredito=banco7338&filtro1=" +
    filtro1 +
    "&fechaInicio=" +
    fechaInicio +
    "&fechaFinal=" +
...
function cargarBanco7338Credito() {
  var filtro1 = $("#departamentoSelect").val();
  var fechaInicio = $("#fechaIni").val();
  var fechaFinal = $("#fechaFin").val();
  var filtro2 = $("#movimientoSelect").val();
  ...
  $(".tablaBanco7338Credito").DataTable({
    ...
    serverSide: true,
    sAjaxSource:
      "ajax/processDataBancos.php?action=bancoCredito&banco=banco7338&filtro1=" +
      filtro1 +
      "&fechaInicio=" +
      fechaInicio +
      "&fechaFinal=" +
...
/*=============================================
  EDITAR BANCO 
  =============================================*/
$(".tablaBanco7338").on("click", ".btnEditarDatos", function () {
...
$(".tablaBanco7338Credito").on("click", ".btnEditarDatos", function () {
  var idBanco = $(this).attr("idBanco");
...
/*=============================================
  MOSTRAR PARCIALES
  =============================================*/
$(".tablaBanco7338").on("click", ".btnVerParciales", function () {
  ...
  $.ajax({
    ...
    success: function (respuesta) {
      ...
      var suma =
        ...
        parseFloat(parcial8) +
        parseFloat(parcial9) +
        parseFloat(parcial10) +
        parseFloat(parcial11) +
        parseFloat(parcial12);
...
/*=============================================
  MOSTRAR PARCIALES
  =============================================*/
$(".tablaBanco7338Credito").on("click", ".btnVerParciales", function () {
  var idPar = $(this).attr("idPar");
