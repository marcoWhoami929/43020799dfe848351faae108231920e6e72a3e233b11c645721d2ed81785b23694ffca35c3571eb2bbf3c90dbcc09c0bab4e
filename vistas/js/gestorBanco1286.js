/*=============================================
CARGAR LA TABLA DINÁMICA DE BANCO1286
=============================================*/
...
$(".tablaBanco1286").DataTable({
   "ajax":"ajax/tablaBanco1286.ajax.php",
   "deferRender": true,
   "retrieve": true,
   "processing": true,
    "fixedHeader": true,
...
$(".tablaBanco1286Credito").DataTable({
   "ajax":"ajax/tablaBanco1286Credito.ajax.php",
   "deferRender": true,
   "retrieve": true,
   "processing": true,
    "iDisplayLength": 10,
...
EDITAR BANCO 
=============================================*/
$(".tablaBanco1286").on("click", ".btnEditarDatos", function(){
...
MOSTRAR PARCIALES
=============================================*/
$(".tablaBanco1286").on("click", ".btnVerParciales", function(){
...
MOSTRAR PARCIALES
=============================================*/
$(".tablaBanco1286Credito").on("click", ".btnVerParciales", function(){
