/*=============================================
CARGAR LA TABLA DINÁMICA DE BANCO0840
=============================================*/
...
$(".tablaBanco0840").DataTable({
   "ajax":"ajax/tablaBanco0840.ajax.php",
   "deferRender": true,
   "retrieve": true,
   "processing": true,
    "fixedHeader": true,
...
$(".tablaBanco0840Credito").DataTable({
   "ajax":"ajax/tablaBanco0840Credito.ajax.php",
   "deferRender": true,
   "retrieve": true,
   "processing": true,
    "iDisplayLength": 10,
...
EDITAR BANCO 
=============================================*/
$(".tablaBanco0840").on("click", ".btnEditarDatos", function(){
...
MOSTRAR PARCIALES
=============================================*/
$(".tablaBanco0840").on("click", ".btnVerParciales", function(){
...
MOSTRAR PARCIALES
=============================================*/
$(".tablaBanco0840Credito").on("click", ".btnVerParciales", function(){
