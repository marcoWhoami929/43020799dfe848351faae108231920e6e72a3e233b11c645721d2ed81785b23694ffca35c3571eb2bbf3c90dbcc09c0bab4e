/*=============================================
CARGAR LA TABLA DINÁMICA DE BANCO1340
=============================================*/
...
$(".tablaBanco1340").DataTable({
   "ajax":"ajax/tablaBanco1340.ajax.php",
   "deferRender": true,
   "retrieve": true,
   "processing": true,
    "fixedHeader": true,
...
$(".tablaBanco1340Credito").DataTable({
   "ajax":"ajax/tablaBanco1340Credito.ajax.php",
   "deferRender": true,
   "retrieve": true,
   "processing": true,
    "iDisplayLength": 10,
...
EDITAR BANCO 
=============================================*/
$(".tablaBanco1340").on("click", ".btnEditarDatos", function(){
...
MOSTRAR PARCIALES
=============================================*/
$(".tablaBanco1340").on("click", ".btnVerParciales", function(){
...
MOSTRAR PARCIALES
=============================================*/
$(".tablaBanco1340Credito").on("click", ".btnVerParciales", function(){
