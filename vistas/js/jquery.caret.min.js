...
!(function (e) {
  e.fn.caret = function (e) {
    ...
    if (0 == arguments.length) {
      ...
      if (document.selection) {
        if ((t.focus(), n)) {
          ...
          return (
            r.moveToElementText(t), r.setEndPoint("EndToEnd", o), r.text.length
          );
        }
        var e = 0,
          c = t.createTextRange(),
    ...
    if (
      (-1 == e && (e = this[n ? "text" : "val"]().length), window.getSelection)
    )
      n
        ? (t.focus(), window.getSelection().collapse(t.firstChild, e))
