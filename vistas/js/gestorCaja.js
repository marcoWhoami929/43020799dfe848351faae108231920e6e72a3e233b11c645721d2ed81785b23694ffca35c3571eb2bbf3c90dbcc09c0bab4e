...
EDITAR Caja 
=============================================*/
$(".tablaCaja").on("click", ".btnEditarDatos", function(){
...
MOSTRAR PARCIALES
=============================================*/
$(".tablaCaja").on("click", ".btnVerParciales", function(){
...
$(".tablaCaja").on("click", ".btnEliminarCaja", function(){
  ...
  swal({
    ...
    if(result.value){
      ...
      window.location = "index.php?ruta=caja&idCaja2="+idCaja2;
