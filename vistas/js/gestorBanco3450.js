/*=============================================
CARGAR LA TABLA DINÁMICA DE BANCO0198
=============================================*/
...
$(".tablaBanco3450").DataTable({
   "ajax":"ajax/tablaBanco3450.ajax.php",
   "deferRender": true,
   "retrieve": true,
   "processing": true,
    "fixedHeader": true,
...
$(".tablaBanco3450Credito").DataTable({
   "ajax":"ajax/tablaBanco3450Credito.ajax.php",
   "deferRender": true,
   "retrieve": true,
   "processing": true,
    "iDisplayLength": 10,
...
EDITAR BANCO 
=============================================*/
$(".tablaBanco3450").on("click", ".btnEditarDatos", function(){
...
EDITAR BANCO 
=============================================*/
$(".tablaBanco3450Credito").on("click", ".btnEditarDatos", function(){
...
MOSTRAR PARCIALES
=============================================*/
$(".tablaBanco3450").on("click", ".btnVerParciales", function(){
...
MOSTRAR PARCIALES
=============================================*/
$(".tablaBanco3450Credito").on("click", ".btnVerParciales", function(){
