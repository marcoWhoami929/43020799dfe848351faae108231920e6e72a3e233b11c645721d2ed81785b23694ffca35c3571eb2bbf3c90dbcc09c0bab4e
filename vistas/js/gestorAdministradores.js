...
=============================================*/
$(".tablaPerfiles").on("click", ".btnCotizador", function(){

  var idPerCotizador = $(this).attr("idPerCotizador");
  var estadoCotizador = $(this).attr("estadoCotizador");

  var datos = new FormData();
  datos.append("activarIdCoti", idPerCotizador);
    datos.append("activarCotizador", estadoCotizador);
    ...
    if(estadoCotizador == 0){

      $(this).removeClass('btn-success');
      $(this).addClass('btn-danger');
      $(this).html('Desactivado');
      $(this).attr('estadoCotizador',1);
...
$(".tablaPerfiles").on("click", ".btnEliminarPerfil", function(){
  ...
  swal({
    ...
    if(result.value){
      ...
      window.location = "index.php?ruta=perfiles&idPerfil="+idPerfil+"&fotoPerfil="+fotoPerfil+"&nombre="+nombre;
